<script setup lang="ts">
  ...
  const loadCandidate = async (id: number) => {
    ...
    try {
      ...
      // candidate.value = sanitazeCandidate(candidateData);
  ...
  //                 initials =
  //                   candidate.value.firstName[0] + candidate.value.surname[0];
  //               } else {
  ...
  //                 initials =
  //                   profile.value.data.data.first_name[0] +
  //                   profile.value.data.data.last_name[0];
  //               }
  //             }
  //           }
  ...
  //                   platformName: 'hh_chat',
  //                   author:
  //                     item.author.participant_type == 'applicant'
  //                       ? `${candidate.value.surname} ${candidate.value.firstName} `
  //                       : company,
  //                   company:
  //                     item.author.participant_type == 'applicant'
  //                       ? employer
  ...
  //               console.warn(
  //                 `Невалидная дата: ${a.timestamp} или ${b.timestamp}`
  //               );
  //               return 0;
  //             }
  //             return dateB - dateA;
  ...
  //       if (
  //         q.type === 'Чекбокс' ||
  //         q.type === 'Мультисписок (вопрос с вариантами ответа)'
  //       ) {
