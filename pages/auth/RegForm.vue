            ...
            <div class="reg__data-wrapper">
                ...
                <div class="reg__inputs p-flex">
                    <div class="reg__email-wrapper">
                        ...
                        <label class="reg__email-label"><input type="email" class="reg__email-input e-input f14w400"
                              placeholder="Введите email" id="email" required v-model="email" /><span v-if="emailError"
                              id="email-error" class="error-message f12w400" style="color: red">{{
                                emailError
                            }}</span></label>
                    </div>
                    <div class="reg__phone-wrapper">
                        ...
                        <label class="reg__phone-label"><input type="tel" class="reg__phone-input e-input f14w400"
                              placeholder="+7" id="phone" required v-model="phone" @focus="onFocusPhone"
                              @blur="onBlurPhone" @input="onInputPhone" /><span v-if="phoneError" id="phone-error"
          ...
          :class="{ 'active': currentStep === 'second' }">
            ...
            <div class="reg__check-pass p-flex">
                <div class="reg__check-first">
                    ...
                    <label class="reg__pass-label"><input type="password" class="reg__check-input e-input f14w400"
                          placeholder="******" id="pass" v-model="password" />
                        <button type="button" class="pass-eye" @click="togglePassword('pass')" data-id="pass"></button>
                        <span v-if="passwordError" id="pass-error" class="error-message f12w400" style="color: red">{{
                            passwordError
                            }}</span></label>
                </div>
          ...
          :class="{ 'active': currentStep === 'third' }">
            ...
            <div class="reg__third-quiz">
                ...
                <div class="reg__quiz-wrapper">
                    ...
                    <label class="reg__quiz-label">
                        <input type="radio" class="reg__quiz-radio checkbox-hide" name="source" />
                        <span class="reg__quiz-value f14w400 radio-visible">Рекламная кампания (звонок, смс)</span>
                    </label>
                </div>
