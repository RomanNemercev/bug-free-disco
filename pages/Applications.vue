    ...
    <div class="w-full leading-normal pl-15px pr-25px rounded-t-fifteen bg-catskill mb-px">
      <div class="header-wrapper grid grid-cols-8 gap-x-2.5 min-h-[71px] items-center">
        <div v-for="header in headers" :key="header.key" class="text-sm font-medium text-slate-custom flex pl-2.5"
          ...
          <button v-if="['dateStart', 'dateWork', 'status'].includes(header.key)"
          ...
          <div>
            <div v-if="userRole === 'admin'">
              ...
              <div v-else>
                ...
                " class="mb-0 w-full max-w-input py-5" :responses="executors" />
              </div>
            </div>
        ...
        <Popup :isOpen="isNewAppPopupAdmin" @close="() => (isNewAppPopupAdmin = false)" :width="'740px'"
          ...
          <div class="mb-22">
            <div class="mb-15px">
              ...
              <response-input class="w-full" :responses="executors"
                :model-value="newApplication.responsible ? newApplication.responsible.name : null" :showRoles="true"
                placeholder="Кому отправить заявку" @update:modelValue="updateNewResponsible" />
            ...
            <div class="w-full flex justify-between gap-x-15px mb-15px">
              <div class="w-full max-w-[400px]">
                ...
                <MyInput placeholder="Введите должность" v-model="newApplication.position" />
              ...
              <div class="w-full">
                ...
                <MyInput placeholder="Введите название подразделения" v-model="newApplication.division" />
            ...
            <div class="w-full mb-2.5">
              ...
              <geo-input v-model="newApplication.city" :placeholder="'Введите город'" />
            ...
            <div class="w-full mb-2.5">
              ...
              <MyInput placeholder="Введите число позиций на вакансию" v-model="newApplication.count"
                :type="'Number'" />
            ...
            <div class="w-full mb-2.5 flex gap-x-15px">
              <div class="w-full">
                ...
                <SalaryRange :from="newApplication.salaryFrom" :to="newApplication.salaryTo"
                  @update:from="newApplication.salaryFrom = $event" @update:to="newApplication.salaryTo = $event" />
            ...
            <div class="w-full mb-15px">
              ...
              <my-dropdown :options="reasonseForOpenVacancy" v-model="newApplication.reason"
            ...
            <div class="w-full">
              ...
              <MyTextarea v-model="newApplication.require" :placeholder="'Опишите ключевые требования'" />
            ...
            <div class="w-full mb-25px">
              ...
              <MyTextarea v-model="newApplication.duty" :placeholder="'Опишите ключевые обязанности кандидата'" />
            ...
            <div class="flex gap-15px justify-between w-fit">
              ...
              <UiButton variant="back" size="second-back" class="font-medium" @click="closeNewApplicationPopup">
                Отмена
              </UiButton>
            </div>
          </div>
            ...
            <div class="grid gap-x-5 grid-flow-col grid-cols-2 mb-5">
              <div>
                ...
                <div ref="executorContainer">
                  <div v-if="newExecutor.name" class="text-sm font-medium text-dodger pl-15px">
                    {{ newExecutor.name }}
                  </div>
              ...
              <div>
                ...
                <div ref="customerContainer">
                  <div v-if="newCustomer.name" class="text-sm font-medium text-dodger pl-15px">
                    {{ newCustomer.name }}
                  </div>
                  ...
                  <response-input class="w-full" :responses="responses" v-model="newCustomer.name"
                    v-show="showNewCustomer" @update:modelValue="(value, id) => updateNewCustomer(value, id)" />
                </div>
              </div>
            </div>
            <div class="grid gap-x-5 grid-flow-col mb-6">
        ...
        <Popup :isOpen="isNewAppPopupCustomer" @close="() => (isNewAppPopupCustomer = false)" :width="'740px'"
          ...
          <div class="mb-22px">
            <div class="mb-6">
              ...
              <BtnResponseInput v-model="newResponseCustomer" :responses="responses" :customer="'responsible'" />
            </div>
            <div class="grid gap-x-5 grid-flow-col mb-6">
              <div>
                <p class="text-sm font-medium text-space pl-15px mb-1">
      ...
      <Popup v-if="selectedVacancy" :isOpen="!!selectedVacancy" @close="closePopup" :width="'750px'"
        ...
        <template #default>
          ...
          <div v-else-if="detailedVacancy">
                ...
                <div v-if="popupSelectedTab === 'popupMainInfo'">
                  <div class="flex gap-x-5 p-25px bg-white rounded-fifteen mb-2.5">
                    <div class="w-full">
                      ...
                      <BtnResponseInput v-model="selectedVacancy.executor" :responses="executors" :customer="'executor'"
                  ...
                  <div class="flex gap-x-5 p-25px bg-white rounded-fifteen mb-2.5">
                    <div class="w-full">
                      ...
                      <BtnAddBindVacancy v-model="vacancy" :vacancies="vacancies" @update:modelValue="updateResponse" />
                    </div>
                    <div class="w-full">
                  ...
                  <div class="p-25px bg-white rounded-fifteen">
                    <div class="flex gap-x-15px mb-5">
                      <div class="w-full">
                        ...
                        <BtnResponseInput :responses="clients" v-model="clientName" :placeholder="'ФИО заказчика'"
                          :minStyles="true" :showRoles="true" :customer="'client'"
                          @update:modelValue="updateResponse" />
                      </div>
                      <div class="w-full">
                        ...
                        <BtnResponseInput :responses="executors" v-model="responsibleName"
                          :placeholder="'ФИО ответственного'" :minStyles="true" :showRoles="true"
                          :customer="'responsible'" @update:modelValue="updateResponse" />
                      </div>
                    </div>
                    <div class="flex gap-x-15px mb-5">
                      <div class="w-full">
            ...
            <div class="flex gap-x-15px">
              <UiButton variant="action" size="semiaction" @click="() => handlerUpdateApplication([], selectedVacancy)">
                Готово</UiButton>
