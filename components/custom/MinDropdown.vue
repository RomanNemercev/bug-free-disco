  ...
  <div class="cursor-pointer relative w-fit" ref="minDropdown">
    <div @click="toggleDropdown">
      <div class="pr-6">
        <div
          :class="{
            'text-slate-custom font-semibold': !selectedOption,
            'text-space font-semibold': selectedOption,
          }"
          class="text-sm"
        >
        ...
        <div
          class="dropdown-arrow top-0 absolute right-0 transition-transform duration-300 text-bali"
          :class="{
    ...
    <transition name="slide-fade">
      <div
        class="absolute w-max bg-white border border-athens rounded-ten shadow-shadow-droplist top-8 z-10"
